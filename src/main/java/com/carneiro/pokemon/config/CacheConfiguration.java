package com.carneiro.pokemon.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.carneiro.pokemon.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.carneiro.pokemon.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
